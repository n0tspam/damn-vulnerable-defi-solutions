...
describe('[Challenge] Side entrance', function () {
    ...
    before(async function () {
        ...
        const AttackerContractPoolFactory = await ethers.getContractFactory('SideEntranceAttackerContract', attacker);

        this.pool = await SideEntranceLenderPoolFactory.deploy();
        this.attackerContract = await AttackerContractPoolFactory.deploy(this.pool.address, attacker.address)
    ...
    it('Exploit', async function () {
        ...
        await this.attackerContract.attack(poolBalance)
        await this.attackerContract.attackerWithdraw()
    });
